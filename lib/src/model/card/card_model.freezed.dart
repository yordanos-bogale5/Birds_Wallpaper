...
mixin _$CardModel {
  ...
  set expiry(DateTime? value) => throw _privateConstructorUsedError;
...
abstract class $CardModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? id, String? type, String? number, DateTime? expiry});
}
...
class _$CardModelImpl extends _CardModel {
  _$CardModelImpl({this.id, this.type, this.number, this.expiry}) : super._();
  ...
  @override
  String toString() {
    return 'CardModel(id: $id, type: $type, number: $number, expiry: $expiry)';
  }
...
abstract class _CardModel extends CardModel {
  factory _CardModel(
      ...
      String? type,
      String? number,
      DateTime? expiry}) = _$CardModelImpl;
