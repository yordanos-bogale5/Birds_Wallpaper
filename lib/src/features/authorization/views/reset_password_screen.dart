...
import 'package:chatremedy/src/features/authorization/provider/reset_password_provider.dart';
...
class _ResetPasswordState extends State<ResetPassword> {
  ...
  updatePassword() {
    log(" ${widget.email} ${widget.token}, ${newPassword.text} ${confirmNewPassword.text}");
    showLoaderDialog(context);
    resetPassword(widget.email, newPassword.text, confirmNewPassword.text,
